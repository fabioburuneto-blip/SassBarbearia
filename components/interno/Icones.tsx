...
export const IEnvelope = (p: P) => (
  <Svg {...p}>
    <rect x="3" y="5" width="18" height="14" rx="2.5" />
    <path d="m4 6.5 8 6.5 8-6.5" />
  </Svg>
);
export const ISelo = (p: P) => (
  <Svg {...p}>
    <path d="M12 3.5c.9 1.2 2.3 1.8 3.7 1.6 1 1 1.4 2.4 1.2 3.7 1.2.9 1.8 2.3 1.6 3.7-1.2.9-1.8 2.3-1.6 3.7-1 1-2.4 1.4-3.7 1.2-.9 1.2-2.3 1.8-3.7 1.6-1.2-.2-2.6-.3-3.7-1.2-1.4.2-2.8-.4-3.7-1.2-.2-1.4-.4-2.8-1.6-3.7-.2-1.4.4-2.8 1.6-3.7-.2-1.4.2-2.8 1.2-3.7 1.4.2 2.8-.4 3.7-1.6.9-.9 2.3-1.4 3.7-1.6Z" />
    <path d="M9.2 12.3l1.9 1.9 3.8-4" />
  </Svg>
);
